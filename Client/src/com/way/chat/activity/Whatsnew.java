...
public class Whatsnew extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		SharePreferenceUtil util = new SharePreferenceUtil(Whatsnew.this,
				Constants.SAVE_USER);
		if (util.getVer().equals(Constants.VERSION)) {
			startbutton(null);
		}
		util.setVer(Constants.VERSION);
	...
	public void startbutton(View v) {
		...
		intent.setClass(Whatsnew.this, WelcomeActivity.class);
