...
public class SharePicActivity extends Activity implements OnClickListener,OnUploadProcessListener{
  ...
  public void onCreate(Bundle savedInstanceState) {
      ...
      setContentView(R.layout.share_pic_by_camer);
	...
	public void onClick(View v) {
		...
		case R.id.camera:
			...
			break;
		case R.id.back:
			AlertDialog.Builder builder = new Builder(SharePicActivity.this); 
