 ...
 * 
 */
public class MyNormalListView extends ListView implements OnScrollListener {
	 ...
	 *            上下文对象
	 */
	public MyNormalListView(Context context) {
		super(context);
		init(context);
	}
	 ...
	 *            属性
	 */
	public MyNormalListView(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}

	public MyNormalListView(Context context, AttributeSet attrs, int defStyle) {
